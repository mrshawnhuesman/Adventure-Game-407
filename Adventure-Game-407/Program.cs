    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            */            
            ...
            var creature1 = new Hero("Anthony", new Weapon(2, 8, false), new Armor(5), 20);
            
            var magic1 = new MagicalMonster("Will", new Weapon(2, 5, false), new Armor(5), 20, 4, offenseSkill, defenseSkill );
