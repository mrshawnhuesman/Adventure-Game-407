...
namespace Adventure_Game_407
{
    ...
    public abstract class Creature
    {
        ...
        public Room Room { get; protected set; }          //creature current room location              
        ...
        {          
            ...
            for (int i = 0; i < Weapon.NumAttacks; i++)               //loop from 0 till the the max number of weapon attacks - 1
            {
                ...
                {
                    int weaponDamage = StaticRandom.Instance.Next(1, Weapon.MaxDamage);   //generate weapon damage between 1 and max weapon damage (inclusive)
            ...
            return totalWeaponDamage;        //returns the total weapon damage
        }
